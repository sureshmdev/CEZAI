...
// --- Raw Prisma shape before mapping ---
interface RawAssessment {
  id: string;
  userId: string;
  quizScore: number;
  questions: JsonValue[]; // raw JSON field
  category: string;
...
function isQuizResultInput(q: unknown): q is QuizResultInput {
  return (
    typeof q === "object" &&
    q !== null &&
    "question" in q &&
...
export default function Quiz() {
  ...
  const finishQuiz = async () => {
    ...
    try {
      ...
      // Map JsonValue[] → QuizResultInput[]
      const mappedQuestions: QuizResultInput[] = result.questions.map((q) => {
      ...
      // Convert RawAssessment → Assessment

...
import type { QuizQuestionInput, QuizResultInput, Assessment } from "@types";
...
// Map RawAssessment.questions (JsonValue[]) → QuizResultInput[]
...
export default function Quiz() {
  ...
  const finishQuiz = async () => {
    ...
    try {
      ...
      const assessment: Assessment = mapToAssessment(rawResult);
      setRawResultData(rawResult); // store raw data for rendering
  ...
  if (rawResultData) {
    const _assessment: Assessment = mapToAssessment(rawResultData);
